...
<ul><li>
    Le premier chiffre correspond au nombre d'éléments testés dans la fact.
    </li><li> 
     Le second chiffre correspond au nombre d'éléments testés dans la référence.
    </li><li>
     Le troisieme chiffre correspond au nombre de d'éléments en commun.
</li></ul>
les mot "chuck" et "norris" ne sont pas testés comme les mots de moins de 2 caractères
